...
export default function About() {
  return (
    <section id="about" className="bg-[#00303C] text-white py-6 sm:py-8 md:py-10 xl:py-12  px-4 sm:px-6 md:px-12 xl:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-2 gap-8 md:gap-12 xl:gap-16 items-start py-4 md:py-6 xl:p-10">
        ...
        <div className="flex flex-col gap-6 sm:gap-11 md:gap-8 space-y-2 md:space-y-0 sm:space-y-3">
          ...
          <div className="flex gap-10 sm:gap-8 md:gap-10 xl:gap-11 items-center">
            ...
            <div className="text-center sm:text-left">
              <h3 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-bold text-[#C6FD07] text-center">3+</h3>
