...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative min-h-150  flex items-center pt-28 px-6 md:px-12 text-[#C6FD07]"
    >
      <div className="relative  w-full max-w-[1224px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <button >
                            <a
                                        ...
                                        className="border border-[#00303C] mt-3 bg-[#C6FD07] px-5 py-2 rounded-full font-semibold flex flex-row justify-center items-center gap-3 shadow-lg text-[#00303C] hover:scale-[1.02] transition text-sm"
                                      >
